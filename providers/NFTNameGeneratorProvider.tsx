...
export const NFTNameGeneratorProvider = ({ children }) => {
  ...
  const mintGeneratedName = useCallback(
    async (ipfsUrl: string, generatedName: string, creator: string) => {
  ...
  const handleGenerateClick = useCallback(async () => {
    ...
    const receipt = await mintGeneratedName(ipfsUrl, generated, generatedBy)
    ...
    setLoading(false)
  }, [twitterHandle, postTweet, getGeneratedName, generateImageURI, mintGeneratedName])
