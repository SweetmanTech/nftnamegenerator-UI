...
const MintButton = () => {
  const { loading, startConfetti, handleGenerateClick } = useNFTNameGenerator()
  ...
  return (
    <>
      <button type="button" onClick={handleGenerateClick} disabled={loading} className={className}>
        {loading && (
          <svg
            role="status"
